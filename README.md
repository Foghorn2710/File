CREATE TABLE employee5 (e_id INT PRIMARY KEY,e_name VARCHAR(10),age INT,salary DECIMAL(10,2));
...
DECLARE emp_cursor CURSOR FOR SELECT e_id,e_name,age,salary FROM employee5;
...
SELECT CONCAT('employee id: ',v_e_id,', name: ',v_e_name,', age: ',v_age,', salary: ',v_salary) AS employee_details;
